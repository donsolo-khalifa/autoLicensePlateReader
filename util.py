...
# def license_complies_format(text):
#     """
#     Check if the license plate text complies with general formats.
#     Allows plate's with 5 to 12 characters.
#     """
#     min_length, max_length = 5, 12  # Adjust as needed
#     if not (min_length <= len(text) <= max_length):
#         return False
#
#     # Ensure at least one letter and one number exists in the plate
#     has_letter = any(c in string.ascii_uppercase for c in text)
#     has_number = any(c in "0123456789" for c in text)
#
...
def customReadPlate(license_plate_crop):
    """
...
def save_to_database(license_plates, start_time, end_time):
    """
       Saves license plate as well as start time and end time to DB.
        """
